...
El proyecto incluye una configuración específica para Vercel sin eliminar su configuración original.

1. Importar el repositorio en Vercel.
2. Elegir `Next.js` como Framework Preset.
3. Mantener la raíz del repositorio como Root Directory.
4. No se requieren variables de entorno para la landing actual.
5. Presionar Deploy.

Vercel utilizará `npm ci` y `npm run build:vercel`. El mismo build puede validarse localmente con:
